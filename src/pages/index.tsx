...
const HomePage = () => {
	...
	const features = [
		...
		{ name: `Control of Your Data`, description: `Sick of this site? Completely delete your account whenever you want from the account tab` },
		{ name: `Easy to Use`, description: `SteelPoll makes creating and sharing polls as simple as possible` },
		{ name: `Secure`, description: `Create polls that are open to anyone or restricted to registered accounts only` },
		...
		{ name: `Mobile Responsive`, description: `Works on your phone, tablet or computer` },
	];
			...
			<main className='container flex flex-col items-center w-full text-center bg-brand-primary'>
				...
				<section className='flex flex-col justify-center max-w-6xl mb-20 lg:mb-32 xl:mb-48'>
					<div className='max-w-3xl mx-auto text-center'>
						...
						<p className='mt-4 text-lg text-brand-secondary'>More robust, private polling than any alternatives, all for free!</p>
					</div>
